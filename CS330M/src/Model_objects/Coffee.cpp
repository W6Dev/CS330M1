...
void Coffee::createMeshes() {
    ...
    cup->Transform = glm::translate(cup->Transform, glm::vec3(7.0, 0.0f, 0.0f));
    ...
    handle->Transform = glm::translate(handle->Transform, glm::vec3(8.9f, 1.20f, 0.0f));
    handle->Transform = glm::rotate(handle->Transform, glm::radians(0.0f), glm::vec3(.0f, 0.0f, 1.0f));
